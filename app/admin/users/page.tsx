          ...
          <table className="w-full text-sm min-w-[540px]">
            <thead>
              <tr className="border-b border-gray-200 bg-gray-50">
                <th className="text-left px-4 sm:px-6 py-3.5 font-semibold text-gray-600">User</th>
                <th className="text-left px-4 sm:px-6 py-3.5 font-semibold text-gray-600 hidden sm:table-cell">Email</th>
                <th className="text-left px-4 sm:px-6 py-3.5 font-semibold text-gray-600 hidden md:table-cell">Role</th>
                <th className="text-left px-4 sm:px-6 py-3.5 font-semibold text-gray-600 hidden md:table-cell">Group</th>
                <th className="text-left px-4 sm:px-6 py-3.5 font-semibold text-gray-600 hidden lg:table-cell">Joined</th>
              ...
              {isLoading ? (
                ...
                users.map((user) => (
                  <tr key={user.id} className="hover:bg-gray-50 transition-colors">
                    ...
                    <td className="px-4 sm:px-6 py-4">
                      <div className="flex items-center gap-3">
                        ...
                        <div className="min-w-0">
                          ...
                          {/* email + badges shown inline on mobile */}
                    ...
                    <td className="px-4 sm:px-6 py-4 text-gray-500 text-xs hidden lg:table-cell">
